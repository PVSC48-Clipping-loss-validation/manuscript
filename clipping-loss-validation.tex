...
\hline
System A & Overall MBE & 5.4\% & 4.8\% & -0.6\\
\hline
System A & MBE (High VI) & 10.7\% & 9.3\% & -1.4\\
\hline
System A & MBE (Medium VI) & 4.3\% & 3.5\% & -0.8 \\
\hline
System A & MBE (Low VI) & 4.4\% & 4.0\% & -0.4\\
\hline
System B & Overall MBE & 7.8\% & 6.7\% & -1.1\\
\hline
System B & MBE (High VI) & 10.4\% & 7.9\% & -2.5\\
\hline
System B & MBE (Medium VI) & 7.7\% & 6.3\% & -1.4\\
\hline
System B & MBE (Low VI) & 7.1\% & 6.5\% & -0.6\\
\hline
\end{tabular}}
\end{center}
\label{table2}
...
\hline
System A & MBE (High VI) & 10.6\% & 9.2\% & -1.4 \\
\hline
System A & MBE (Medium VI) & 3.1\% & 2.4\% & -0.7\\
\hline
System A & MBE (Low VI) & 1.1\% & 0.8\% & -0.3\\
\hline
System B & Overall MBE & 3.6\% & 2.8\% & -0.8\\
\hline
System B & MBE (High VI) & 8.7\% & 6.1\% & -2.6\\
\hline
System B & MBE (Medium VI) & 4.4\% & 3.0\% & -1.4\\
\hline
System B & MBE (Low VI) & 2.8\% & 2.4\% & -0.4\\
\hline
\end{tabular}}
\end{center}
